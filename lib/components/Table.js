...
var Table = react_1.default.memo(function (props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("table", { className: "" + (props.className || ""), style: props.style },
            react_1.default.createElement("thead", null,
                react_1.default.createElement("tr", null, lodash_1.default.map(props.columnHeadings, function (value, key) {
                    ...
                    return (react_1.default.createElement("th", { scope: "col", key: value.keyIndex, onClick: function (e) { return !value.sortable ? setOrderStatus(sortKey, e) : null; }, style: value.headerStyle },
            ...
            react_1.default.createElement("tbody", null, lodash_1.default.map(lodash_1.default.orderBy(totalData[paginationIndex], lodash_1.default.split("" + orderBy, ","), [orderDirection]), function (row, key) {
                return (react_1.default.createElement("tr", { key: key + "-" + paginationIndex, onClick: function () { return onRowItemClick(row, key); }, style: props.rowStyle }, lodash_1.default.map(props.columnHeadings, function (column, columnKeyIndex) {
